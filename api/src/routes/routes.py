...
from shared.schemas.dependencies import verify_api_key, get_db_public

# Import service functions
from shared.services.agent_service import (
    register_or_update_agent, get_unread_mentions, list_all_agents, delete_agent
)
from shared.services.task_service import (
    get_next_task_for_agent, wait_for_next_task
)
from shared.services.task_management_service import (
...
from shared.services.epic_feature_service import (
...
def get_agents_availability(
    ...
    from shared.services.agent_service import get_agents_availability
...
def get_agent_availability(
    ...
    from shared.services.agent_service import get_agent_availability
...
def get_context(project_id: int, db: Session = Depends(get_session)):
    from shared.services.project_service import get_project
...
def get_next_task(role: AgentRole = None, level: DifficultyLevel = None, 
    ...
    if simulate:
        ...
        from shared.services.task_service import get_next_task_for_agent
        from shared.models.models import Agent
...
def list_projects(db: Session = Depends(get_session)):
    from shared.services.project_service import list_all_projects
